...
class _$ItemResponseImpl implements _ItemResponse {
  ...
  @override
  String toString() {
    return 'ItemResponse(id: $id, title: $title, description: $description, price: $price, discountPercentage: $discountPercentage, rating: $rating, stock: $stock, brand: $brand, category: $category, thumbnail: $thumbnail, images: $images)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$ItemResponseImplToJson(
      this,
    );
  }
}
...
abstract class _ItemResponse implements ItemResponse {
  factory _ItemResponse(
      ...
      final String? category,
      final String? thumbnail,
      final List<String>? images}) = _$ItemResponseImpl;
